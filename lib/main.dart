...
Future<void> _validateWebCryptoAssets() async {
  try {
    await rootBundle.load(
      '${_vodozemacWebAssetPrefix}vodozemac_bindings_dart.js',
    );
    await rootBundle.load(
      '${_vodozemacWebAssetPrefix}vodozemac_bindings_dart_bg.wasm',
    );
  } catch (e, s) {
    Logs().e(
      'Web crypto assets are missing. Run ./scripts/prepare-web.sh before building/running web.',
      e,
      s,
    );
    rethrow;
