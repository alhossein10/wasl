...
class SettingsStyleView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final selectedLocale = controller.currentLocale.languageCode == 'en'
        ? const Locale('en')
        : const Locale('ar');
    final languageTitle = selectedLocale.languageCode == 'ar'
        ? 'اللغة'
        : 'Language';
            ...
            Padding(
              ...
              child: SegmentedButton<Locale>(
                ...
                onSelectionChanged: (selected) =>
                    controller.switchLocale(selected.single),
                segments: const [
