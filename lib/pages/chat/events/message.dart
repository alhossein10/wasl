...
class Message extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (event.redacted || displayEvent.redacted) {
      return const SizedBox.shrink();
    }
    const tightenedCorner = Radius.circular(10);
    const roundedCorner = Radius.circular(AppConfig.borderRadius + 4);
    ...
    final maxBubbleWidth =
        (isColumnMode
                ? FluffyThemes.columnWidth * 1.35
                : MediaQuery.sizeOf(context).width * 0.8)
            .clamp(220.0, FluffyThemes.maxTimelineWidth)
            .toDouble();
    final noBubble =
        ({
              MessageTypes.Video,
      ...
      child: Swipeable(
        ...
        child: Container(
          ...
          padding: EdgeInsets.only(
            left: 10.0,
            right: 10.0,
            top: nextEventSameSender ? 1.5 : 6.0,
            bottom: previousEventSameSender ? 1.5 : 6.0,
          ),
          child: Column(
            mainAxisSize: .min,
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        color: theme.colorScheme.surfaceContainerHighest
                            .withAlpha(170),
                        border: Border.all(
                          color: theme.colorScheme.outlineVariant.withAlpha(95),
                          width: 0.6,
                        ),
                      ),
                      child: Text(
