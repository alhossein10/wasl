...
class ChatView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final hasCustomWallpaper = accountConfig.wallpaperUrl != null;
                  ...
                  children: <Widget>[
                    ...
                    if (hasCustomWallpaper)
                      Positioned.fill(
                        child: Opacity(
                          opacity:
                              ((accountConfig.wallpaperOpacity ?? 0.24).clamp(
                                        0.08,
                                        0.30,
                                      )
                                      as num)
                          ...
                          child: ImageFiltered(
                            imageFilter: ui.ImageFilter.blur(
                              sigmaX: (accountConfig.wallpaperBlur ?? 0.0) + 2,
                              sigmaY: (accountConfig.wallpaperBlur ?? 0.0) + 2,
                            ),
                            child: MxcImage(
