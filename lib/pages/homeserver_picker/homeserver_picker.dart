...
class HomeserverPickerController extends State<HomeserverPicker> {
  ...
  bool get isStrictSingleHomeserver => AppConfig.strictSingleHomeserver;

  final TextEditingController homeserverController = TextEditingController(
    text: AppConfig.strictSingleHomeserver
  ...
  Future<void> checkHomeserverAction({bool legacyPasswordLogin = false}) async {
    if (isStrictSingleHomeserver) {
      homeserverController.text = AppConfig.forcedHomeserverHost;
    }

    final homeserverInput =
        (isStrictSingleHomeserver
                ? AppConfig.forcedHomeserverHost
