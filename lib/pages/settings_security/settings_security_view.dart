                        ...
                        children: [
                          ...
                          if (controller.hasPin)
                            ListTile(
                              ...
                              title: Text(L10n.of(context).removePin),
                              subtitle: Text(L10n.of(context).removePinWarning),
                              onTap: controller.removePinAction,
                            ),
                          SwitchListTile.adaptive(
                            value: controller.hasPin &&
                                controller.biometricSupported &&
                                controller.biometricEnabled,
                            onChanged: controller.biometricSupported
                                ? controller.changeFingerprintAction
                                : null,
                            title: Text(L10n.of(context).useFingerprintToUnlockTitle),
                            subtitle: Text(
                              controller.hasPin
                                  ? L10n.of(context).useFingerprintToUnlockDescription
                                  : L10n.of(context).setPinFirst,
                            ),
                          ),
                        ],
                      ),
